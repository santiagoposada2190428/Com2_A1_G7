...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.constelacion = constelacion = (-3-3j,-3-1j,-3+1j,-3+3j,-1-3j,-1-1j,-1+1j,-1+3j,3-3j,3-1j,3+1j,3+3j,1-3j,1-1j,1+1j,1+3j)
        self.Sps = Sps = 16
        self.Rs = Rs = 56000
        ...
        self.BW_filtro = BW_filtro = Rs/2 *(1+beta)

        ##################################################
        # Blocks
        ##################################################

        self._beta_range = qtgui.Range(0, 1, 1/100, 0.5, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._Pn_range = qtgui.Range(0, 0.1, 0.1/100, 0.07, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._BW_filtro_range = qtgui.Range(0, Fmax, Fmax/100, Rs/2 *(1+beta), 200)
    ...
    def set_Rs(self, Rs):
        self.Rs = Rs
        self.set_BW_filtro(self.Rs/2 *(1+self.beta))
